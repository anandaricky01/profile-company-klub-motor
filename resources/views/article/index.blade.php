...
@section('container')
<section id="article" class="p-10 bg-gray-100 mt-16">
        ...
        @for($i = 0; $i < 5; $i++)
            <div class="col-span-3 md:col-span-1 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                    ...
                    <a href="{{ route('article.show') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Read more
